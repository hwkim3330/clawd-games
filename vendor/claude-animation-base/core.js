...
// [claude-charm] canvas size comes from PROJECT.w / PROJECT.h (the charm's screen is square).
...
async function setup() {
  ...
  window.ready = true;
  if (!location.search.includes('render') && document.getElementById('scrub')) devUI();  // [claude-charm] no studio UI on the charm
}
function draw() {
